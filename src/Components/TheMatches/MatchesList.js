                        ...
                        {nodes.map(({ key, data, state: { x, opacity } }) => (
                            <div key={key} className="match_box_big" style={{ opacity, transform: `translate(${x}px)` }}>
                                <div className="block_wraper">
                                    <div className="block">
                                        <div style={{ background: `url(/images/team_icons/${data.localThmb}.png)` }} className="icon"></div>
                                        <div className="team">{data.local}</div>
                                        <div className="result">{data.resultLocal}</div>
                                    </div>
                                    <div className="block">
                                        <div style={{ background: `url(/images/team_icons/${data.awayThmb}.png)` }} className="icon"></div>
